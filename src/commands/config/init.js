    ...
    async run(msg, args) {
        ...
        msg.channel.send({
            ...
            if (msg.guild.sevendtdServer) {
                addLineToDescription(embed, `:warning: There already is a server configured for this guild, deleting the old one.`)
                msg.guild.sevendtdServer.destroy()
            }
            ...
            await request(requestOptions)
                .then(function(response) {
                    if (response.gametime) {
                        ...
                        throw new Error(`Response does not have expected data.`)
                    }
                })
                    ...
                    await request(requestOptions)
                        .then(function(response) {
                            if (response) {
                                ...
                                throw new Error('Response is not what was expected when executing command. Confirm you set a correct port')
                            }
                        })
                        .catch(function(error) {
